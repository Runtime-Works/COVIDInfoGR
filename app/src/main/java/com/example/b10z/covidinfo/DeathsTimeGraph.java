...
public class DeathsTimeGraph extends Fragment {


    public DeathsTimeGraph (){
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        for (int i = 0; i<Timelinelist.get(0).length; i++ ) {
            if (i > 2) {
                TimelineEntries.add(new BarEntry((float)(i-2),Float.valueOf(Timelinelist.get(4)[i])));
            }
        }

        BarDataSet set = new BarDataSet(TimelineEntries, "Deaths/Time");
